...
class ConnectingViewController: UIViewController {
    ...
    private let selectedPlan: WorkoutPlanConfig
    ...
    override func viewDidLoad() {
        ...
        engine.start(plan: selectedPlan)
    }
    ...
    private func startPulse() {
        ...
        for (i, ring) in ringViews.enumerated() {
            ...
            anim.fromValue      = 0.8; anim.toValue = 0.0
            anim.duration       = 1.6; anim.repeatCount = .infinity
...
extension ConnectingViewController: WorkoutEngineDelegate {
    ...
    func engineDidConnect() {
        let dash = DashboardViewController(engine: engine, plan: selectedPlan)
